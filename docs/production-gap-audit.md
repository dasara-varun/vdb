...
| P0 | Durability proof across filesystems | File replacement and directory-entry persistence vary by platform | Use the [`durability-matrix.md`](durability-matrix.md) as the evidence contract; add directory synchronization where supported, a platform matrix, and bounded crash tests |
